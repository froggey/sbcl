...
(define-instruction-set :advsimd
  (:test (advsimd-supported-p))
  (:include :arm64)
  (:simd-packs
  ...
  (:loads
   ...
   (f32.4-load-2      #:ld1  (f32.4 f32.4) f32vec f32-array f32.4-aref-2 f32.4-row-major-aref-2)
   (f32.4-load-2-interleaved #:ld2 (f32.4 f32.4) f32vec f32-array f32.4-aref-2-interleaved f32.4-row-major-aref-2-interleaved)
   (f32.4-load-3      #:ld1  (f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-3 f32.4-row-major-aref-3)
   (f32.4-load-3-interleaved #:ld3 (f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-3-interleaved f32.4-row-major-aref-3-interleaved)
   (f32.4-load-4      #:ld1  (f32.4 f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-4 f32.4-row-major-aref-4)
   (f32.4-load-4-interleaved #:ld4 (f32.4 f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-4-interleaved f32.4-row-major-aref-4-interleaved)
   (f64.2-load        #:ldr  f64.2 f64vec f64-array f64.2-aref f64.2-row-major-aref)
   (f64.2-load-2      #:ld1  (f64.2 f64.2) f64vec f64-array f64.2-aref-2 f64.2-row-major-aref-2)
   (f64.2-load-2-interleaved #:ld2 (f64.2 f64.2) f64vec f64-array f64.2-aref-2-interleaved f64.2-row-major-aref-2-interleaved)
   (f64.2-load-3      #:ld1  (f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-3 f64.2-row-major-aref-3)
   (f64.2-load-3-interleaved #:ld3 (f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-3-interleaved f64.2-row-major-aref-3-interleaved)
   (f64.2-load-4      #:ld1  (f64.2 f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-4 f64.2-row-major-aref-4)
   (f64.2-load-4-interleaved #:ld4 (f64.2 f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-4-interleaved f64.2-row-major-aref-4-interleaved)
   (u8.16-load        #:ldr  u8.16 u8vec  u8-array  u8.16-aref u8.16-row-major-aref)
   (u8.16-load-2      #:ld1  (u8.16 u8.16) u8vec u8-array u8.16-aref-2 u8.16-row-major-aref-2)
   (u8.16-load-2-interleaved #:ld2 (u8.16 u8.16) u8vec u8-array u8.16-aref-2-interleaved u8.16-row-major-aref-2-interleaved)
   (u8.16-load-3      #:ld1  (u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-3 u8.16-row-major-aref-3)
   (u8.16-load-3-interleaved #:ld3 (u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-3-interleaved u8.16-row-major-aref-3-interleaved)
   (u8.16-load-4      #:ld1  (u8.16 u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-4 u8.16-row-major-aref-4)
   (u8.16-load-4-interleaved #:ld4 (u8.16 u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-4-interleaved u8.16-row-major-aref-4-interleaved)
   (u16.8-load        #:ldr  u16.8 u16vec u16-array u16.8-aref u16.8-row-major-aref)
   (u16.8-load-2      #:ld1  (u16.8 u16.8) u16vec u16-array u16.8-aref-2 u16.8-row-major-aref-2)
   (u16.8-load-2-interleaved #:ld2 (u16.8 u16.8) u16vec u16-array u16.8-aref-2-interleaved u16.8-row-major-aref-2-interleaved)
   (u16.8-load-3      #:ld1  (u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-3 u16.8-row-major-aref-3)
   (u16.8-load-3-interleaved #:ld3 (u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-3-interleaved u16.8-row-major-aref-3-interleaved)
   (u16.8-load-4      #:ld1  (u16.8 u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-4 u16.8-row-major-aref-4)
   (u16.8-load-4-interleaved #:ld4 (u16.8 u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-4-interleaved u16.8-row-major-aref-4-interleaved)
   (u32.4-load        #:ldr  u32.4 u32vec u32-array u32.4-aref u32.4-row-major-aref)
   (u32.4-load-2      #:ld1  (u32.4 u32.4) u32vec u32-array u32.4-aref-2 u32.4-row-major-aref-2)
   (u32.4-load-2-interleaved #:ld2 (u32.4 u32.4) u32vec u32-array u32.4-aref-2-interleaved u32.4-row-major-aref-2-interleaved)
   (u32.4-load-3      #:ld1  (u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-3 u32.4-row-major-aref-3)
   (u32.4-load-3-interleaved #:ld3 (u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-3-interleaved u32.4-row-major-aref-3-interleaved)
   (u32.4-load-4      #:ld1  (u32.4 u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-4 u32.4-row-major-aref-4)
   (u32.4-load-4-interleaved #:ld4 (u32.4 u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-4-interleaved u32.4-row-major-aref-4-interleaved)
   (u64.2-load        #:ldr  u64.2 u64vec u64-array u64.2-aref u64.2-row-major-aref)
   (u64.2-load-2      #:ld1  (u64.2 u64.2) u64vec u64-array u64.2-aref-2 u64.2-row-major-aref-2)
   (u64.2-load-2-interleaved #:ld2 (u64.2 u64.2) u64vec u64-array u64.2-aref-2-interleaved u64.2-row-major-aref-2-interleaved)
   (u64.2-load-3      #:ld1  (u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-3 u64.2-row-major-aref-3)
   (u64.2-load-3-interleaved #:ld3 (u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-3-interleaved u64.2-row-major-aref-3-interleaved)
   (u64.2-load-4      #:ld1  (u64.2 u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-4 u64.2-row-major-aref-4)
   (u64.2-load-4-interleaved #:ld4 (u64.2 u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-4-interleaved u64.2-row-major-aref-4-interleaved)
   (s8.16-load        #:ldr  s8.16 s8vec  s8-array  s8.16-aref s8.16-row-major-aref)
   (s8.16-load-2      #:ld1  (s8.16 s8.16) s8vec s8-array s8.16-aref-2 s8.16-row-major-aref-2)
   (s8.16-load-2-interleaved #:ld2 (s8.16 s8.16) s8vec s8-array s8.16-aref-2-interleaved s8.16-row-major-aref-2-interleaved)
   (s8.16-load-3      #:ld1  (s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-3 s8.16-row-major-aref-3)
   (s8.16-load-3-interleaved #:ld3 (s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-3-interleaved s8.16-row-major-aref-3-interleaved)
   (s8.16-load-4      #:ld1  (s8.16 s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-4 s8.16-row-major-aref-4)
   (s8.16-load-4-interleaved #:ld4 (s8.16 s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-4-interleaved s8.16-row-major-aref-4-interleaved)
   (s16.8-load        #:ldr  s16.8 s16vec s16-array s16.8-aref s16.8-row-major-aref)
   (s16.8-load-2      #:ld1  (s16.8 s16.8) s16vec s16-array s16.8-aref-2 s16.8-row-major-aref-2)
   (s16.8-load-2-interleaved #:ld2 (s16.8 s16.8) s16vec s16-array s16.8-aref-2-interleaved s16.8-row-major-aref-2-interleaved)
   (s16.8-load-3      #:ld1  (s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-3 s16.8-row-major-aref-3)
   (s16.8-load-3-interleaved #:ld3 (s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-3-interleaved s16.8-row-major-aref-3-interleaved)
   (s16.8-load-4      #:ld1  (s16.8 s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-4 s16.8-row-major-aref-4)
   (s16.8-load-4-interleaved #:ld4 (s16.8 s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-4-interleaved s16.8-row-major-aref-4-interleaved)
   (s32.4-load        #:ldr  s32.4 s32vec s32-array s32.4-aref s32.4-row-major-aref)
   (s32.4-load-2      #:ld1  (s32.4 s32.4) s32vec s32-array s32.4-aref-2 s32.4-row-major-aref-2)
   (s32.4-load-2-interleaved #:ld2 (s32.4 s32.4) s32vec s32-array s32.4-aref-2-interleaved s32.4-row-major-aref-2-interleaved)
   (s32.4-load-3      #:ld1  (s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-3 s32.4-row-major-aref-3)
   (s32.4-load-3-interleaved #:ld3 (s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-3-interleaved s32.4-row-major-aref-3-interleaved)
   (s32.4-load-4      #:ld1  (s32.4 s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-4 s32.4-row-major-aref-4)
   (s32.4-load-4-interleaved #:ld4 (s32.4 s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-4-interleaved s32.4-row-major-aref-4-interleaved)
   (s64.2-load        #:ldr  s64.2 s64vec s64-array s64.2-aref s64.2-row-major-aref)
   (s64.2-load-2      #:ld1  (s64.2 s64.2) s64vec s64-array s64.2-aref-2 s64.2-row-major-aref-2)
   (s64.2-load-2-interleaved #:ld2 (s64.2 s64.2) s64vec s64-array s64.2-aref-2-interleaved s64.2-row-major-aref-2-interleaved)
   (s64.2-load-3      #:ld1  (s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-3 s64.2-row-major-aref-3)
   (s64.2-load-3-interleaved #:ld3 (s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-3-interleaved s64.2-row-major-aref-3-interleaved)
  ...
  (:stores
   ...
   (f32.4-store-2     #:st1  (f32.4 f32.4) f32vec f32-array f32.4-aref-2 f32.4-row-major-aref-2)
   (f32.4-store-2-interleaved #:st2 (f32.4 f32.4) f32vec f32-array f32.4-aref-2-interleaved f32.4-row-major-aref-2-interleaved)
   (f32.4-store-3     #:st1  (f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-3 f32.4-row-major-aref-3)
   (f32.4-store-3-interleaved #:st3 (f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-3-interleaved f32.4-row-major-aref-3-interleaved)
   (f32.4-store-4     #:st1  (f32.4 f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-4 f32.4-row-major-aref-4)
   (f32.4-store-4-interleaved #:st4 (f32.4 f32.4 f32.4 f32.4) f32vec f32-array f32.4-aref-4-interleaved f32.4-row-major-aref-4-interleaved)
   (f64.2-store       #:str  f64.2 f64vec f64-array f64.2-aref f64.2-row-major-aref)
   (f64.2-store-2     #:st1  (f64.2 f64.2) f64vec f64-array f64.2-aref-2 f64.2-row-major-aref-2)
   (f64.2-store-2-interleaved #:st2 (f64.2 f64.2) f64vec f64-array f64.2-aref-2-interleaved f64.2-row-major-aref-2-interleaved)
   (f64.2-store-3     #:st1  (f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-3 f64.2-row-major-aref-3)
   (f64.2-store-3-interleaved #:st3 (f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-3-interleaved f64.2-row-major-aref-3-interleaved)
   (f64.2-store-4     #:st1  (f64.2 f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-4 f64.2-row-major-aref-4)
   (f64.2-store-4-interleaved #:st4 (f64.2 f64.2 f64.2 f64.2) f64vec f64-array f64.2-aref-4-interleaved f64.2-row-major-aref-4-interleaved)
   (u8.16-store       #:str  u8.16 u8vec  u8-array  u8.16-aref u8.16-row-major-aref)
   (u8.16-store-2     #:st1  (u8.16 u8.16) u8vec u8-array u8.16-aref-2 u8.16-row-major-aref-2)
   (u8.16-store-2-interleaved #:st2 (u8.16 u8.16) u8vec u8-array u8.16-aref-2-interleaved u8.16-row-major-aref-2-interleaved)
   (u8.16-store-3     #:st1  (u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-3 u8.16-row-major-aref-3)
   (u8.16-store-3-interleaved #:st3 (u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-3-interleaved u8.16-row-major-aref-3-interleaved)
   (u8.16-store-4     #:st1  (u8.16 u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-4 u8.16-row-major-aref-4)
   (u8.16-store-4-interleaved #:st4 (u8.16 u8.16 u8.16 u8.16) u8vec u8-array u8.16-aref-4-interleaved u8.16-row-major-aref-4-interleaved)
   (u16.8-store       #:str  u16.8 u16vec u16-array u16.8-aref u16.8-row-major-aref)
   (u16.8-store-2     #:st1  (u16.8 u16.8) u16vec u16-array u16.8-aref-2 u16.8-row-major-aref-2)
   (u16.8-store-2-interleaved #:st2 (u16.8 u16.8) u16vec u16-array u16.8-aref-2-interleaved u16.8-row-major-aref-2-interleaved)
   (u16.8-store-3     #:st1  (u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-3 u16.8-row-major-aref-3)
   (u16.8-store-3-interleaved #:st3 (u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-3-interleaved u16.8-row-major-aref-3-interleaved)
   (u16.8-store-4     #:st1  (u16.8 u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-4 u16.8-row-major-aref-4)
   (u16.8-store-4-interleaved #:st4 (u16.8 u16.8 u16.8 u16.8) u16vec u16-array u16.8-aref-4-interleaved u16.8-row-major-aref-4-interleaved)
   (u32.4-store       #:str  u32.4 u32vec u32-array u32.4-aref u32.4-row-major-aref)
   (u32.4-store-2     #:st1  (u32.4 u32.4) u32vec u32-array u32.4-aref-2 u32.4-row-major-aref-2)
   (u32.4-store-2-interleaved #:st2 (u32.4 u32.4) u32vec u32-array u32.4-aref-2-interleaved u32.4-row-major-aref-2-interleaved)
   (u32.4-store-3     #:st1  (u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-3 u32.4-row-major-aref-3)
   (u32.4-store-3-interleaved #:st3 (u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-3-interleaved u32.4-row-major-aref-3-interleaved)
   (u32.4-store-4     #:st1  (u32.4 u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-4 u32.4-row-major-aref-4)
   (u32.4-store-4-interleaved #:st4 (u32.4 u32.4 u32.4 u32.4) u32vec u32-array u32.4-aref-4-interleaved u32.4-row-major-aref-4-interleaved)
   (u64.2-store       #:str  u64.2 u64vec u64-array u64.2-aref u64.2-row-major-aref)
   (u64.2-store-2     #:st1  (u64.2 u64.2) u64vec u64-array u64.2-aref-2 u64.2-row-major-aref-2)
   (u64.2-store-2-interleaved #:st2 (u64.2 u64.2) u64vec u64-array u64.2-aref-2-interleaved u64.2-row-major-aref-2-interleaved)
   (u64.2-store-3     #:st1  (u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-3 u64.2-row-major-aref-3)
   (u64.2-store-3-interleaved #:st3 (u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-3-interleaved u64.2-row-major-aref-3-interleaved)
   (u64.2-store-4     #:st1  (u64.2 u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-4 u64.2-row-major-aref-4)
   (u64.2-store-4-interleaved #:st4 (u64.2 u64.2 u64.2 u64.2) u64vec u64-array u64.2-aref-4-interleaved u64.2-row-major-aref-4-interleaved)
   (s8.16-store       #:str  s8.16 s8vec  s8-array  s8.16-aref s8.16-row-major-aref)
   (s8.16-store-2     #:st1  (s8.16 s8.16) s8vec s8-array s8.16-aref-2 s8.16-row-major-aref-2)
   (s8.16-store-2-interleaved #:st2 (s8.16 s8.16) s8vec s8-array s8.16-aref-2-interleaved s8.16-row-major-aref-2-interleaved)
   (s8.16-store-3     #:st1  (s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-3 s8.16-row-major-aref-3)
   (s8.16-store-3-interleaved #:st3 (s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-3-interleaved s8.16-row-major-aref-3-interleaved)
   (s8.16-store-4     #:st1  (s8.16 s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-4 s8.16-row-major-aref-4)
   (s8.16-store-4-interleaved #:st4 (s8.16 s8.16 s8.16 s8.16) s8vec s8-array s8.16-aref-4-interleaved s8.16-row-major-aref-4-interleaved)
   (s16.8-store       #:str  s16.8 s16vec s16-array s16.8-aref s16.8-row-major-aref)
   (s16.8-store-2     #:st1  (s16.8 s16.8) s16vec s16-array s16.8-aref-2 s16.8-row-major-aref-2)
   (s16.8-store-2-interleaved #:st2 (s16.8 s16.8) s16vec s16-array s16.8-aref-2-interleaved s16.8-row-major-aref-2-interleaved)
   (s16.8-store-3     #:st1  (s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-3 s16.8-row-major-aref-3)
   (s16.8-store-3-interleaved #:st3 (s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-3-interleaved s16.8-row-major-aref-3-interleaved)
   (s16.8-store-4     #:st1  (s16.8 s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-4 s16.8-row-major-aref-4)
   (s16.8-store-4-interleaved #:st4 (s16.8 s16.8 s16.8 s16.8) s16vec s16-array s16.8-aref-4-interleaved s16.8-row-major-aref-4-interleaved)
   (s32.4-store       #:str  s32.4 s32vec s32-array s32.4-aref s32.4-row-major-aref)
   (s32.4-store-2     #:st1  (s32.4 s32.4) s32vec s32-array s32.4-aref-2 s32.4-row-major-aref-2)
   (s32.4-store-2-interleaved #:st2 (s32.4 s32.4) s32vec s32-array s32.4-aref-2-interleaved s32.4-row-major-aref-2-interleaved)
   (s32.4-store-3     #:st1  (s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-3 s32.4-row-major-aref-3)
   (s32.4-store-3-interleaved #:st3 (s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-3-interleaved s32.4-row-major-aref-3-interleaved)
   (s32.4-store-4     #:st1  (s32.4 s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-4 s32.4-row-major-aref-4)
   (s32.4-store-4-interleaved #:st4 (s32.4 s32.4 s32.4 s32.4) s32vec s32-array s32.4-aref-4-interleaved s32.4-row-major-aref-4-interleaved)
   (s64.2-store       #:str  s64.2 s64vec s64-array s64.2-aref s64.2-row-major-aref)
   (s64.2-store-2     #:st1  (s64.2 s64.2) s64vec s64-array s64.2-aref-2 s64.2-row-major-aref-2)
   (s64.2-store-2-interleaved #:st2 (s64.2 s64.2) s64vec s64-array s64.2-aref-2-interleaved s64.2-row-major-aref-2-interleaved)
   (s64.2-store-3     #:st1  (s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-3 s64.2-row-major-aref-3)
   (s64.2-store-3-interleaved #:st3 (s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-3-interleaved s64.2-row-major-aref-3-interleaved)
   (s64.2-store-4     #:st1  (s64.2 s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-4 s64.2-row-major-aref-4)
   (s64.2-store-4-interleaved #:st4 (s64.2 s64.2 s64.2 s64.2) s64vec s64-array s64.2-aref-4-interleaved s64.2-row-major-aref-4-interleaved))
  (:associatives
