...
(define-custom-vop sb-simd-advsimd::f32!-from-p128
...
(define-custom-vop sb-simd-advsimd::f32.4!-from-f32
...
(define-custom-vop sb-simd-advsimd:f32.4-dup
...
(define-custom-vop sb-simd-advsimd:f32.4-lane-extract
  (:args (src :scs (single-neon-reg)))
  (:info lane)
  (:results (dst :scs (single-reg)))
  (:generator
...
(define-custom-vop sb-simd-advsimd:f32.4-lane-insert
...
(define-custom-vop sb-simd-advsimd:f32.4-ins
  (:args (src1 :scs (single-neon-reg) :target dst)
...
(define-custom-vop sb-simd-advsimd::f64!-from-p128
...
(define-custom-vop sb-simd-advsimd::f64.2!-from-f64
...
(define-custom-vop sb-simd-advsimd:f64.2-dup
...
(define-custom-vop sb-simd-advsimd:f64.2-lane-extract
  (:args (src :scs (double-neon-reg)))
  (:info lane)
  (:results (dst :scs (double-reg)))
  (:generator
...
(define-custom-vop sb-simd-advsimd:f64.2-lane-insert
...
(define-custom-vop sb-simd-advsimd:f64.2-ins
  (:args (src1 :scs (double-neon-reg) :target dst)
...
(define-custom-vop sb-simd-advsimd:u8.16-shuffle
