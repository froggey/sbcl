...
(in-package "SB-VM")

(defun float-neon-p (tn)
  (sc-is tn single-neon-reg single-neon-stack single-neon-immediate
            double-neon-reg double-neon-stack double-neon-immediate))
(defun int-neon-p (tn)
  (sc-is tn int-neon-reg int-neon-stack int-neon-immediate))

#+sb-xc-host
...
(define-move-fun (load-neon-immediate 1) (vop x y)
  ((int-neon-immediate single-neon-immediate double-neon-immediate)
